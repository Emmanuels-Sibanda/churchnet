...
const sendEmail = async (to, subject, html, text = null) => {
  // If SendGrid is not configured, log email instead
  if (!process.env.SENDGRID_API_KEY) {
...
/**
 * Booking request notification to venue owner
 */
...
/**
 * Booking approval notification to booker
 */
...
/**
 * Booking rejection notification to booker
 */
